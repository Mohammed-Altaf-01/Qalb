...
const AUTH_REDIRECT_URI =
  process.env.QURAN_PRELIVE_REDIRECT_URI ??
  process.env.QURAN_OAUTH_REDIRECT_URI ??
  `${(process.env.NEXTAUTH_URL ?? DEFAULT_APP_ORIGIN).replace(/\/$/, "")}/api/auth/callback/${QURAN_FOUNDATION_PROVIDER_ID}`;
