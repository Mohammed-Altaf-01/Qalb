...
export const LEVELS = [
  { level: 1, title: "Seeker",  titleAr: "طالب",   minXp: 0,    color: "text-slate-400",  bg: "bg-slate-400/10"  },
  { level: 2, title: "Reader",  titleAr: "قارئ",   minXp: 100,  color: "text-emerald-400", bg: "bg-emerald-400/10" },
  { level: 3, title: "Student", titleAr: "طالب علم", minXp: 300, color: "text-sky-400",    bg: "bg-sky-400/10"    },
  { level: 4, title: "Scholar", titleAr: "عالم",   minXp: 700,  color: "text-violet-400", bg: "bg-violet-400/10" },
  { level: 5, title: "Hafiz",   titleAr: "حافظ",   minXp: 1500, color: "text-amber-400",  bg: "bg-amber-400/10"  },
  { level: 6, title: "Imam",    titleAr: "إمام",   minXp: 3000, color: "text-yellow-400", bg: "bg-yellow-400/10" },
];
...
export const BADGES = {
  ...
  first_chat:       { id: "first_chat",       icon: "💬", title: "Conversationalist",   desc: "Had your first conversation with a verse",     xp: 15  },
  first_discover:   { id: "first_discover",   icon: "🔍", title: "Seeker",              desc: "Used AI discovery for the first time",         xp: 10  },
  ...
  reflective_5:     { id: "reflective_5",     icon: "🤔", title: "Deep Thinker",        desc: "Generated reflections on 5 different verses",  xp: 30  },
  ...
  night_owl:        { id: "night_owl",        icon: "🌙", title: "Night Worshipper",    desc: "Engaged with the Quran after midnight",        xp: 20  },
  early_bird:       { id: "early_bird",       icon: "🌅", title: "Fajr Reader",         desc: "Engaged with the Quran before 6 AM",           xp: 20  },
  read_10_surahs:   { id: "read_10_surahs",   icon: "📚", title: "Surah Explorer",      desc: "Read verses from 10 different surahs",         xp: 35  },
  complete_goal:    { id: "complete_goal",    icon: "✅", title: "Goal Achiever",       desc: "Completed your first reading goal",            xp: 50  },
  level_scholar:    { id: "level_scholar",    icon: "🎓", title: "Scholar Rank",        desc: "Reached Scholar level (700 XP)",               xp: 0   },
...
const CHALLENGE_POOL = [
  { id: "read_daily_verse",    title: "Read the Daily Verse",         desc: "Visit and read today's featured verse",           xp: 15, action: "read_verse_page"    },
  { id: "reflect_on_verse",    title: "Reflect on a Verse",           desc: "Generate AI reflections on any verse",            xp: 20, action: "generate_reflection"},
  { id: "listen_recitation",   title: "Listen to a Recitation",       desc: "Play the audio for any verse",                    xp: 15, action: "play_audio"         },
  { id: "discover_verse",      title: "Discover with AI",             desc: "Use 'What's on your mind?' to find a verse",      xp: 20, action: "discover_search"    },
  { id: "save_reflection",     title: "Write a Reflection",           desc: "Save a personal note on any verse",               xp: 25, action: "save_note"          },
  { id: "chat_verse",          title: "Talk to a Verse",              desc: "Have a conversation about any verse",             xp: 20, action: "chat_message"       },
  { id: "bookmark_something",  title: "Save a Verse",                 desc: "Bookmark a verse that moves you today",           xp: 15, action: "bookmark_verse"     },
];
