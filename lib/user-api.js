...
class UserRepository {
  ...
  static async getStreak(userToken) {
    return userApiRequest("/api/v1/streaks", userToken);
  }
  ...
  static async getActivity(userToken) {
    return userApiRequest("/api/v1/activity_days", userToken);
  }
  ...
  static async recordReadingSession(userToken, sessionData) {
    return userApiRequest("/api/v1/reading_sessions", userToken, {
      method: "POST",
  ...
  static async getGoals(userToken) {
    return userApiRequest("/api/v1/goals", userToken);
  }
  ...
  static async updateGoal(userToken, goalId, updates) {
    return userApiRequest(`/api/v1/goals/${goalId}`, userToken, {
      method: "PATCH",
  ...
  static async getBookmarks(userToken) {
    return userApiRequest("/api/v1/bookmarks", userToken);
  }
  ...
  static async removeBookmark(userToken, verseKey) {
    return userApiRequest(`/api/v1/bookmarks/${verseKey}`, userToken, {
      method: "DELETE",
    });
  }
  ...
  static async getCollections(userToken) {
    return userApiRequest("/api/v1/collections", userToken);
  }
  ...
  static async addToCollection(userToken, collectionId, verseKey) {
    return userApiRequest(`/api/v1/collections/${collectionId}/verses`, userToken, {
      method: "POST",
      body: JSON.stringify({ verse_key: verseKey }),
    });
  }
  ...
  static async removeFromCollection(userToken, collectionId, verseKey) {
    return userApiRequest(`/api/v1/collections/${collectionId}/verses/${verseKey}`, userToken, {
      method: "DELETE",
    });
  }
  ...
  static async deleteCollection(userToken, collectionId) {
    return userApiRequest(`/api/v1/collections/${collectionId}`, userToken, {
      method: "DELETE",
    });
  }
  ...
  static async getNotes(userToken) {
    return userApiRequest("/api/v1/notes", userToken);
  }
  ...
  static async updateNote(userToken, noteId, text) {
    return userApiRequest(`/api/v1/notes/${noteId}`, userToken, {
      method: "PATCH",
  ...
  static async getPreferences(userToken) {
    return userApiRequest("/api/v1/preferences", userToken);
  }
