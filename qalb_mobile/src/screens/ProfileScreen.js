        ...
        {isSignedIn ? (
          <>
            ...
            <TouchableOpacity
              ...
              onPress={async () => {
                ...
                Alert.alert(
                  "Sync",
                  r.cloudEnabled ? "Cloud data merged." : "Cloud storage unavailable or not signed in.",
                );
              }}
            >
          ...
          <>
            <Text style={styles.body}>
              Sign in with the same Quran Foundation account as the website to sync reading data.
            </Text>
            <TouchableOpacity
              style={styles.btn}
              onPress={async () => {
